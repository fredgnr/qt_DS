...
public:
    ...
    void setupUi(QWidget *GraphWidget)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(1310, 590, 160, 205));
        ...
        stopptn = new QPushButton(verticalLayoutWidget);
        stopptn->setObjectName(QStringLiteral("stopptn"));

        verticalLayout->addWidget(stopptn);
    ...
    void retranslateUi(QWidget *GraphWidget)
    {
        ...
        stopptn->setText(QApplication::translate("GraphWidget", "\345\201\234\346\255\242\346\222\255\346\224\276", 0));
    } // retranslateUi
